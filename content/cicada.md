...
---
# User flag
 Looked on DEV by smbclient which is <span style="color:rgb(255, 192, 0)">readable</span> by <span style="color:rgb(255, 192, 0)">david</span> user and we found a file which has 
